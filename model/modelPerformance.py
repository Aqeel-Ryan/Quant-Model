...
def plotgraphs2():
    ...
    plt.legend()
    plt.tight_layout()
    st.subheader("Cumulative P&L for XGBoost")
    st.pyplot(fig1)
    ...
    plt.legend()
    plt.tight_layout()
    st.subheader("Predicted Returns with Confidence Intervals (XGBoost)")
    st.pyplot(fig2)
    ...
    plt.tight_layout()
    st.subheader("Confusion Matrix for Trading Signals (XGBoost)")
    st.pyplot(fig3)
